                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('siswa.prosesLogin') }}" method="post" class="my-login-validation" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <input oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;" type="text" minlength="10" maxlength="10" class="form-control" name="nisn" placeholder="NISN Siswa" required autofocus>
