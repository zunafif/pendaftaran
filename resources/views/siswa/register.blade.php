                        ...
                        <form method="post" action="{{ route('siswa.registerProses') }}" enctype="multipart/form-data" class="my-login-validation" novalidate="">
                            ...
                            <div class="form-group">
                                <label for="password">NISN
                                    <a href="#" target="_blank" class="float-right" data-toggle="modal" data-target="#exampleModal">
                                        Tidak ingat NISN Kamu?
                                    </a>
                                </label>
                                <input oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;"  maxlength="10" minlength="10" class="form-control" name="nisn" placeholder="Masukkan NISN" required data-eye>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama" value="{{ old('nama') }}" placeholder="Masukkan Nama Lengkap" required autofocus>
                                <div class="invalid-feedback">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br><br>
                <a href="https://referensi.data.kemdikbud.go.id/nisn/index.php/Cindex/formcaribynama" target="_blank">referensi.data.kemdikbud.go.id/nisn</a>
            </div>
        </div>
    </div>
</div>
