                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('jurusan_id_jurusan') is-invalid @enderror" name="jurusan_id_jurusan">
                                @foreach($jurusan as $j)
                                    <option value="{{ $j->id_jurusan }}" @if ($j->id_jurusan == $biayagelombang->jurusan_id) selected @endif>{{ $j->nama_jurusan }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('gelombang_id_gelombang') is-invalid @enderror" name="gelombang_id_gelombang">
                                @foreach($gelombang as $j)
                                    <option value="{{ $j->id_gelombang }}" @if ($j->id_gelombang == $biayagelombang->gelombang_id) selected @endif>{{ $j->nama_gelombang }}</option>
                                @endforeach
                            </select>
