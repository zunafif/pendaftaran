...
class AdminController extends Controller
{
    public function index(){
        ...
        return view('admin.home', compact('jurusan','siswa','dataDiriLengkap','registrasi','menungguVerifikasiPembayaranFormulir','menungguDiterima','diterima','menungguVerifikasiPembayaranDaftarUlang','sudahDiterimadiSekolah','rupiahDariFormulir','hasilDariDaftarUlang','jumlahSiswaDiterimaDijurusan','namaJurusan'));
    }
